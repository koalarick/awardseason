            ...
            <div className="relative overflow-hidden rounded-2xl border border-amber-100 bg-gradient-to-br from-amber-50 via-white to-rose-50 p-6 shadow">
              ...
              <div className="relative">
                ...
                <div className="mt-5 flex flex-wrap gap-2">
                  <span className="px-3 py-1 rounded-full bg-white/70 text-xs font-semibold text-slate-700 border border-slate-200">Private pools</span>
                  <span className="px-3 py-1 rounded-full bg-white/70 text-xs font-semibold text-slate-700 border border-slate-200">Live scoring</span>
                  <span className="px-3 py-1 rounded-full bg-white/70 text-xs font-semibold text-slate-700 border border-slate-200">Odds multipliers</span>
                  <span className="px-3 py-1 rounded-full bg-white/70 text-xs font-semibold text-slate-700 border border-slate-200">Custom payouts</span>
                </div>
              </div>
            </div>
              ...
              <div className="px-4 sm:px-6 py-6">
                <ul className="space-y-4 text-sm text-gray-700">
                  <li className="flex items-start gap-3">
                    ...
                    <span><strong className="oscars-dark">Bragging rights, guaranteed.</strong> Your leaderboard updates as winners are announced.</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-yellow-600 font-bold mt-0.5">◆</span>
                    <span><strong className="oscars-dark">No spreadsheets.</strong> Invite friends, track picks, and score automatically.</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-yellow-600 font-bold mt-0.5">◆</span>
                    <span><strong className="oscars-dark">Flexible pools.</strong> Free, paid, casual, or competitive — you decide.</span>
                  </li>
                </ul>
              </div>
            </div>
              ...
              <div className="px-4 sm:px-6 py-6">
                <div className="grid gap-4 sm:grid-cols-3 text-sm text-gray-700">
                  ...
                  <div className="rounded-lg border border-gray-200 p-3 bg-gray-50">
                    ...
                    <div className="text-xs text-gray-600 mt-1">Choose winners across every category.</div>
                  </div>
                  <div className="rounded-lg border border-gray-200 p-3 bg-gray-50">
